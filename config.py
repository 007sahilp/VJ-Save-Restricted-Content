...
ADMINS = int(os.environ.get("ADMINS", "784061923"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://platypuspandf:2oljPLWbgg3AHZNz@cluster0.ay7s4qv.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
